...
//        refresh();
        double temp = Math.round( ((lastKnownPrice - initialBuyPrice)*(initialNoOfShares))*100);
        temp /= 100;
        return temp;     //return true if trend is increasing and false if it is decreasing
    }
